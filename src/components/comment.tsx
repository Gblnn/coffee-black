...
export default function Comment(props:Props){
    ...
    return(
        <>
        <div style={{border:"", alignItems:"center", background:"rgba(100 100 100/ 10%)", padding:"0.5rem", paddingRight:"1.25rem",paddingLeft:"1rem", borderRadius:"0.5rem", marginBottom:"1rem"}}>
