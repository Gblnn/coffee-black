    ...
    return(
        ...
        <div className="post">
            ...
            { props.bio==""||props.bio==null ? null :
                ...
                <div className='bio' style={{background:"", height:"fit-content", margin:"0.75rem", marginTop:"0rem",marginBottom:"0.5rem", borderRadius:"0.5rem", display:"flex", alignItems:"center", paddingLeft:"0.25rem",paddingRight:"0.25rem"}}>
