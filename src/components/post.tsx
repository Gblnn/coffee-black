    ...
    return(
        ...
        <div className="post">
            ...
            { props.bio==""||props.bio==null ? null :
                ...
                <div className='bio' style={{background:"", height:"fit-content", margin:"0.5rem", marginTop:"",marginBottom:"0.75rem", borderRadius:"0.5rem", display:"flex", alignItems:"center", paddingLeft:"0.25rem",paddingRight:"0.25rem"}}>
                    <div style={{display:"flex", margin:"0.5rem"}}>

                    
                    <p style={{fontSize:"0.85rem"}}><strong>{props.author}</strong>{showMore? props.bio : props.bio.substring(0, 50)+" ..."}
                    {
                    props.bio.length>50?<a className='hoverable' style={{fontSize:"0.85rem",fontWeight:500, marginLeft:"0.5rem", cursor:"pointer"}} onClick={()=>setShowMore(!showMore)}>{showMore?"- Less":"More"}</a>:null
                    }
                    </p>
